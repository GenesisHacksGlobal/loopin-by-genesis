...
export const SocialToggleGroup: React.FC<SocialToggleGroupProps> = ({
  ...
  const platforms: Array<{
    ...
    { key: 'github', label: 'GitHub Profile', icon: GithubIcon, placeholder: 'https://github.com/username' },
    { key: 'linkedin', label: 'LinkedIn URL', icon: LinkedinIcon, placeholder: 'https://linkedin.com/in/username' },
    { key: 'twitter', label: 'X / Twitter Handle', icon: TwitterIcon, placeholder: 'https://x.com/username' },
    { key: 'discord', label: 'Discord Username', icon: DiscordIcon, placeholder: 'username#1234' },
    { key: 'portfolio', label: 'Personal Website', icon: GlobeIcon, placeholder: 'https://yourwebsite.dev' },
    { key: 'instagram', label: 'Instagram Handle', icon: InstagramIcon, placeholder: 'https://instagram.com/username' },
  ];
